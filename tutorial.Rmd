...
We will use Google Trends to see how search interest in psychological therapies is changing, and whether this is associated with changes in service use.

## R basics

### Command prompt  
The console window on the bottom of R Studio shows the command prompt. 
> tells us that R is ready for our commands.  
